---
title: "Frame Schemas: Defining Backtest Time Windows"
sidebarTitle: "Frames"
description: "How addFrameSchema configures the time window, candle interval, and date range for a backtest-kit strategy run."
---
...
| `interval` | `CandleInterval` | Candle interval used during the simulation (`"1m"`, `"5m"`, `"15m"`, `"30m"`, `"1h"`, `"2h"`, `"4h"`, `"6h"`, `"8h"`, `"1d"`). |
