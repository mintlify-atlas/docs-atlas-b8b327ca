---
title: "Docker Compose Setup: MongoDB, Redis, and backtest-kit Container"
sidebarTitle: "Docker Compose"
description: "Configure and launch the full backtest-kit Redis+MongoDB stack using docker-compose, with separate infrastructure containers and a backtest-kit application container."
---
...
# Full stack
npm run start:docker   # or: MODE=backtest ENTRY=1 UI=1 STRATEGY_FILE=./build/index.cjs docker-compose up -d
npm run stop:docker
