...
description: "Complete reference for all environment variables in backtest-kit-redis-mongo-docker, covering MongoDB and Redis connection settings and runtime CLI flags."
---
