---
title: "RedisService: ioredis Connection Management"
...
Establishes the ioredis connection to Redis. Safe to call multiple times — the `singleshot` wrapper ensures the handshake occurs exactly once and all concurrent callers await the same promise.
