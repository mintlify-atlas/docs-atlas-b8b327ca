...
description: "API reference for the BaseMap factory class that provides get, set, delete, has, keys, values, toArray, iterate, size, and clear operations over namespaced Redis keys."
---
