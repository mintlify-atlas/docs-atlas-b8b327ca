...
description: "Reference for three soft-delete adapters: Measure caches LLM responses, Interval tracks once-per-candle guards, Memory stores per-signal key-value pairs."
---
