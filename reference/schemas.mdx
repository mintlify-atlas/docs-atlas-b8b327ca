...
description: "Mongoose schema definitions for all 15 MongoDB collections in backtest-kit-redis-mongo-docker, including field types, indexes, and soft-delete schemas."
---
